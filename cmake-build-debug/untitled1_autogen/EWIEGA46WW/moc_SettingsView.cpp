...
Q_CONSTINIT const QMetaObject SettingsView::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSettingsViewENDCLASS_t,
        ...
        // method 'continueEasyMode'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'continueHardMode'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'startNewEasyMode'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'startNewHardMode'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'saveAndExit'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
...
void SettingsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->continueEasyMode(); break;
        case 1: _t->continueHardMode(); break;
        case 2: _t->startNewEasyMode(); break;
        case 3: _t->startNewHardMode(); break;
        case 4: _t->saveAndExit(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SettingsView::continueEasyMode; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SettingsView::*)();
            if (_t _q_method = &SettingsView::continueHardMode; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SettingsView::*)();
            if (_t _q_method = &SettingsView::startNewEasyMode; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (SettingsView::*)();
            if (_t _q_method = &SettingsView::startNewHardMode; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (SettingsView::*)();
            if (_t _q_method = &SettingsView::saveAndExit; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 0
void SettingsView::continueEasyMode()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SettingsView::continueHardMode()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SettingsView::startNewEasyMode()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void SettingsView::startNewHardMode()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void SettingsView::saveAndExit()
{
