...
public:
    ...
    void showDeletionEffectAnimation();//锤子
    void showMakeBombEffectAnimation();
    void showMakeRowEliminatorEffectAnimation();
    void showMakeColumnEliminatorEffectAnimation();
    void showRefreshAllEffectAnimation();
